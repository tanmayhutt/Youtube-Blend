...
export const Circle = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={cn("absolute w-24 h-24 drop-shadow-[4px_4px_0_rgba(0,0,0,1)]", className)}>
...
export const Squiggle = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 200 50" className={cn("absolute w-32 h-12 drop-shadow-[4px_4px_0_rgba(0,0,0,1)]", className)}>
...
export const Star = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={cn("absolute w-16 h-16 drop-shadow-[4px_4px_0_rgba(0,0,0,1)]", className)}>
...
export const Pill = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 40" className={cn("absolute w-28 h-12 drop-shadow-[4px_4px_0_rgba(0,0,0,1)]", className)}>
